...
create or replace table etsy-data-warehouse-dev.madelinecollins.xp_feature_tags_desktop_units as (
SELECT
  xp.variant_id,
  xp.bucketing_id,
  -- metrics
...
create or replace table etsy-data-warehouse-dev.madelinecollins.xp_feature_tags_desktop_filtered_units as (
SELECT
  xp.variant_id,
  xp.bucketing_id,
  -- metrics
