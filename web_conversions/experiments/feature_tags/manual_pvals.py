...
from `etsy-data-warehouse-dev.madelinecollins.xp_feature_tags_desktop_units`
;"""
...
results.to_csv('feature_tags_desktop.csv')  # Set index=False to avoid saving the index column
