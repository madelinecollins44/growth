...
select
  ...
  case when date_diff(current_date(), create_date, month)  > 12 and date_diff(current_date(), create_date, month)  <= 24 then '1 - 2 years'
      when date_diff(current_date(), create_date, month)  > 24 and date_diff(current_date(), create_date, month)  <= 36 then '2 - 3 years'
      when date_diff(current_date(), create_date, month)  > 36 and date_diff(current_date(), create_date, month)  <= 48 then '3 - 4 years'
      when date_diff(current_date(), create_date, month)  > 48 and date_diff(current_date(), create_date, month)  <= 60 then '4 - 5 years'
      when date_diff(current_date(), create_date, month)  > 60 and date_diff(current_date(), create_date, month)  <= 72 then '5 - 6 years'
      when date_diff(current_date(), create_date, month)  > 72 and date_diff(current_date(), create_date, month)  <= 84 then '6 - 7 years'
      when date_diff(current_date(), create_date, month)  > 84 and date_diff(current_date(), create_date, month)  <= 96 then '7 - 8 years'
