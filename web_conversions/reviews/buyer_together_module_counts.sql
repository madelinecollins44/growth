...
-- create or replace table etsy-data-warehouse-dev.madelinecollins.bundle_modules_listing_events as (
-- select
...
from 
	etsy-data-warehouse-dev.madelinecollins.bundle_modules_listing_events
)
, listing_views as (
select
	visit_id,
