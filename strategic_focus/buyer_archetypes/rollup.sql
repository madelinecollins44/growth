...
select
	...
	s.craftsmanship_score_category
from 
  `etsy-data-warehouse-dev.madelinecollins.buyers_2023` a
join 
...
, transactions as (
	...
	s.craftsmanship_score,
	s.craftsmanship_score_category
from `etsy-data-warehouse-dev.madelinecollins.buyers_2022` a
join `etsy-data-warehouse-prod.transaction_mart.all_transactions` t
on t.mapped_user_id = a.mapped_user_id
...
/* STEP 2: in rollup, continue to insert 2025 mapped_user_id data */ 
---- insert 2025 buyers

delete from `etsy-data-warehouse-dev.madelinecollins.all_buyers` year in ('2025');
